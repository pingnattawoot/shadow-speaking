...
export default function PracticeSection({ sentences, onReset }: PracticeSectionProps) {
  const [currentIndex, setCurrentIndex] = useState(0)
  const { voices, selectedVoice, setSelectedVoice, speak, isSpeaking } = useSpeechSynthesis()
  ...
  return (
    <div className="w-full max-w-3xl flex flex-col items-center gap-8 animate-fade-in">
      ...
      <div className="glass-card w-full rounded-3xl p-8 md:p-12 min-h-[200px] 
        ...
        <p key={currentIndex} className="text-2xl md:text-3xl lg:text-4xl text-center 
      ...
      <div className="flex flex-col items-center gap-6 w-full">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            onClick={handleSpeak}
            className={`btn-primary p-6 relative group ${isSpeaking ? 'animate-pulse' : ''}`}
          >
